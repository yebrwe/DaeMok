...
특수벽은 강철·화염·독·빙결·바람·위상·가시·수정의 8종입니다. 화염벽은 캐릭터를 불태우고 2행동 동안 진짜벽과 같은 열기 환영벽을 섞으며, 독벽은 다음 4행동마다 25% 확률로 입력을 다른 유효 방향으로 뒤틉니다. 빙결·바람의 강제 이동, 위상벽의 차단/통과 교대 등 종류별 상호작용이 있으며 각 벽은 최대 1개만 배치할 수 있습니다. 가짜벽은 제작자 화면을 포함한 모든 2D·3D 시점에서 정상벽과 완전히 같은 형상과 진한 적색으로 표시되고, 처음 충돌하기 전까지 무기한 유지됩니다.

최종 벽 비용은 가짜벽과 웜홀이 각각 7이며 나머지 함정·특수벽은 1입니다. 웜홀 제작자는 외부 입구·복귀 지점에 이어 별도의 6×6 내부 미로에서 시작점, 봉인 3개, 잠긴 출구와 4~12개의 벽을 설정합니다. 주자는 봉인을 모두 밟아야 설정된 외부 출구로 돌아오며, 내부 최단 완료 동선은 12~28칸으로 검증됩니다. 모든 아이템은 종류별 1개로 제한되고 탐지기와 플레이어 스킬은 신규 맵 제작·저장과 공식 턴 처리에서 제거되었습니다.
